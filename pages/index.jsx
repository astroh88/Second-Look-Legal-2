    ...
    <main className="p-8 max-w-5xl mx-auto space-y-12">
      ...
      <section className="bg-gray-100 p-6 rounded-xl">
        ...
        <form className="space-y-4">
          ...
          <Textarea placeholder="What kind of contract is this? (e.g. SAFE, NDA, MSA)" />
      ...
      <section className="p-6 bg-white rounded-xl">
        ...
        <Button onClick={() => window.open('https://buy.stripe.com/test_bIY3eU9I52ep4rS6oo')}>Upgrade & Pay</Button>
      </section>
      ...
      <section className="p-6 bg-white rounded-xl">
        ...
        <Button onClick={() => window.open('https://calendly.com/secondlooklegal/consult')}>Book Now</Button>
      </section>
